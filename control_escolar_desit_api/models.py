...
class Materias(models.Model):
    id = models.BigAutoField(primary_key=True)
    nrc = models.CharField(max_length=5, unique=True, null=False, blank=False)
    nombre = models.CharField(max_length=255, null=False, blank=False)
    seccion = models.CharField(max_length=3, null=False, blank=False)
    dias = models.JSONField(null=False, blank=False)  # Lista de días: ['Lunes', 'Martes', etc.]
    ...
    profesor = models.ForeignKey(Maestros, on_delete=models.CASCADE, null=False, blank=False)
